...
- **Request profile** — the ordered set of request-body parameters sent to
  ...
  `<AppData>/LLocr/profiles/request.json`, merged by name (ADR 56);
  `RequestProfileStore` (QML singleton `RequestProfiles`) owns it.
