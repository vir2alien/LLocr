...
2. **ASan / verify-only:** I-04/I-05 — needs an ASan-instrumented build (I-05 note: `OcrModel` is not a QObject, so "parent the watcher" is not applicable without a larger refactor). Investigations I-01, I-02, I-06, I-07 — ✅ fixed in round 7; I-10…I-13 — ✅ fixed in round 3. Remaining verify-only: I-14 (ModelsTab search-vs-installed staleness), I-15 (wizard clipping in Russian locale) — manual recipes in §3.
